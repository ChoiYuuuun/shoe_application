...
import com.example.test5.databinding.ActivityAuthBinding
...
class AuthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.signBtn.setOnClickListener {
            ...
            MyApplication.auth.createUserWithEmailAndPassword(email, password) //이메일과 비밀번호를 대입하여 구글 파이어베이스와 연동
                .addOnCompleteListener(this){task ->
